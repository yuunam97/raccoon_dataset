...
ORIG_BASE_PATH = "C:/Users/Yuu/Desktop/OD project/raccoon_dataset/raccoon_dataset"
...
# Number of max proposals used (for Selective Search) when running selective
# search for (1) gathering training data and (2) performing inference
MAX_PROPOSALS = 2000
MAX_PROPOSALS_INFER = 200

# define the maximum number of positive and negative image regions to be
